...
<nav id="sidebar" class="sidebar nav-collapse collapse">
    ...
    <div class="content container">
        <h2 class="page-title">Projects - <span class="fw-semi-bold">List</span></h2>

                    <section class="widget">
                        <header>
                            <h4><span class="fw-semi-bold">list</span></h4>
                ...
                <div class="mt">
                    <table id="datatable-table" class="table table-striped table-hover">
                        ...
                        <tr>
                            <th>Id</th>
                            <th>Name</th>
                            <th class="no-sort hidden-xs">Type</th>
                            <th class="hidden-xs">update assets</th>
                        ...
                        <tbody>
                        <tr>
                            <td id="row1ID" name="row1ID">1</td>
                            <td><span class="fw-semi-bold" id="row1name" name="row1name">Algerd</span></td>
                            <td class="hidden-xs">
                                <small>
                                    <span class="fw-semi-bold" id="row1type" name="row1type">Type:</span>
                                    &nbsp; JPEG
                                </small>
                                <br>
                                <small>
                            ...
                            <td class="hidden-xs" id="row1operation" name="row1operation"><a href="#" >Palo Alto</a></td>
                            <td class="hidden-xs" id="row1date" name="row1date">June 27, 2013</td>
                            <td class="width-150">
